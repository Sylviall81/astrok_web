...
if (!mounted) return null
  ...
  return (
        <header className="sticky top-0 z-50 w-full border-b bg-background/95 dark:bg-[#000309] backdrop-blur">
      <div className="max-w-7xl mx-auto px-4 md:px-6 flex h-16 items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <Image
              src={theme === 'dark' 
                ? 'https://res.cloudinary.com/dgtuiirc7/image/upload/v1776253747/logoBlanco_gs6lzj.png' : 'https://res.cloudinary.com/dgtuiirc7/image/upload/v1742251136/logonegro_snez0h.png'}
        ...
        <nav className={`${isMenuOpen ? "flex" : "hidden"
                          ...
                          bg-white dark:bg-slate-900 shadow-xl md:bg-transparent md:shadow-none`}>
